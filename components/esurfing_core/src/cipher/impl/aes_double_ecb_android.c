/**
 * Double-layer AES-128-ECB — 从 CVersion aes_double_ecb_android.c 移植
 * Algo Id: DEABB8C8-A2BC-48CA-8ED0-8CDF1BD62F61
 *
 * 两层 AES-128-ECB (32 字节 key), 无 CBC 链, 无 IV 前缀, 零填充.
 */
...
cipher_interface_t* create_aes_double_ecb_android_cipher(const uint8_t* key)
{
    ...
    aes_double_ecb_android_data_t* d = malloc(sizeof(aes_double_ecb_android_data_t));
