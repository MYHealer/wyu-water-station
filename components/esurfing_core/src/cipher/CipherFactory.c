...
static cipher_interface_t* create_cipher_factory(const char* algo_id)
{
    ...
    // --- Android new algorithms ---
    // 07E824B2: SNOW3G-variant (流密码, 非 SM4-CBC)
    if (strcmp(algo_id, "07E824B2-9E5C-4D1B-BBB0-5E07C251E4AA") == 0)
    {
        LOG_DEBUG("命中 07E824B2 (SNOW3G-variant)");
    ...
    // BB2EA626: double AES-128-CBC (Android)
    if (strcmp(algo_id, "BB2EA626-590B-4C42-82BE-E052FCBBB88E") == 0)
    {
        LOG_DEBUG("命中 BB2EA626 (double AES-CBC)");
    ...
    // AD8BB5B0: six-layer DES-ECB (Android)
    if (strcmp(algo_id, "AD8BB5B0-0E72-4198-A362-96D52C1B7ED1") == 0)
    {
        LOG_DEBUG("命中 AD8BB5B0 (six-layer DES-ECB)");
